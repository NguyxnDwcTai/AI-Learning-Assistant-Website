    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="mb-6">
        ...
        className="group inline-flex items-center gap-2 text-sm font-medium text-slate-600 hover:text-emerald-600 transition-colors duration-200">
          <ArrowLeft className="w-4 h-4 transition-transform group-hover:-translate-x-1 duration-200" strokeWidth={2}/>
          Back to Document
        </Link>
      </div>
                ...
                {result.options.map((option, optIndex) => {
                  ...
                  return (
                    ...
                    className={`relative px-4 py-3 rounded-lg border-2 transition-all duration-200 ${
                      isCorrectOption
                      ? 'bg-emerald-50 border-emerald-300 shadow-lg shadow-emerald-500/15'
                      : isWrongAnswer
                    ...
                    >
                      <div className="flex items-center justify-between gap-3">
                        ...
                        <div className="flex items-center gap-2">
                          {isCorrectOption && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-emerald-50 border border-emerald-300 rounded-lg text-xs font-semibold text-emerald-800">
                              <CheckCircle2 className="w-3 h-3" strokeWidth={2.5}/>
                              Correct
                            </span>
                          )}
                          {isWrongAnswer && (
                            <span className="inline-flex items-center gap-1 px-2 py-1 bg-rose-50 border border-rose-300 rounded-lg text-xs font-semibold text-rose-800">
