...
const QuizTakePage = () => {
    ...
    return (
      <div className="flex items-center justify-center h-[60vh]">
        <div className="text-center">
          <p className="text-lg text-slate-600">Quiz not found or has no questions.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      { /* Question Card */ }
      <div className="bg-white/80 backdrop-blur-xl border-2 border-slate-200 rounded-2xl p-6 shadow-xl shadow-slate-200/50 mb-6">
      ...
      <div className="mt-0 flex items-center justify-center gap-2 flex-wrap">
        {quiz.questions.map((_, index) => {
          ...
          return (
            ...
            disabled={submitting}
            className={`w-8 h-8 rounded-lg font-semibold text-xs transition-colors duration-200 ${
              isCurrent
