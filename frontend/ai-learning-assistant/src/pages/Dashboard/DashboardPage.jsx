    ...
    <div className='min-h-screen'>
      ...
      <div className='relative max-w-7xl mx-auto'>
        ...
        <div className='bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6'>
          ...
          {dashboardData.recentActivity && dashboardData.recentActivity.length > 0 || dashboardData.recentActivity.quizzes.length > 0 ? (
              ...
              .map((activity, index) => (
                ...
                className='group flex items-center justify-between p-4 rounded-xl bg-slate-50/50 border border-slate-200/60 hover:bg-white hover:border-slate-300/60 hover:shadow-md transition-all duration-200'>
                  ...
                  {activity.link && (
                    ...
                    className='ml-4 px-4 py-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-all duration-200 whitespace-nowrap'>View</a>
                  )}
                </div>
              ))}
            </div>
