...
const FlashcardManager = ({documentId}) => {
    ...
    const handleToggleStar = async (cardId) => {
        try {
            ...
            toast.success("Flashcard starred/unstarred successfully");
        } catch (error) {
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col items-center space-y-8">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        className="group inline-flex items-center gap-2 px-5 h-11 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-slate-100">
                            <ChevronLeft
    ...
    const renderSetList = () => {
        ...
        if (flashcardSets.length === 0) {
            ...
            <div className="flex flex-col items-center justify-center py-16 px-6">
                ...
                <h3 className="text-xl font-semibold mb-8 text-slate-900 mb-2">No Flashcards Yet</h3>
                <p className="text-sm text-slate-500 mb-8 text-center max-w-md">Generate flashcards from your document to start learning and reinforce your knowledge.</p>
                <button
                        ...
                        className="group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10">
                            ...
                            <div className="space-y-4">
                                <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-linear-to-br from-emerald-100 to-teal-100">
                                    <Brain className="w-6 h-6 text-emerald-600" strokeWidth={2.25}/>
                                </div>
                                <div>
    ...
    return (
        ...
        >
            <div className="space-y-6">
                ...
                disabled={deleting}
                className="px-5 h-11 bg-linear-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 shadow-lg shadow-rose-500/25 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100">
                    {deleting ? (
