...
const FlashcardSetCard = ({flashcardSet}) => {
    ...
    return (
        <div className='group relative bg-white/80 rounded-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/10 flex flex-col justify-between' onClick={handleStudyNow}>
